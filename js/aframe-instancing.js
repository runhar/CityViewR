...
/***/ function(module, exports) {
	...
	AFRAME.registerComponent('instancing', {
	  ...
	  update: function () {
	    ...
	    geometry.copy(new THREE.SphereBufferGeometry(.003));
	    ...
	    for (var i = 0; i < count; i++) {
	      translateArray[i*3+0] = (Math.random() - 0.5) * 1;
	      translateArray[i*3+1] = (Math.random() - 0.5) * 1;
	      translateArray[i*3+2] = (Math.random() - 0.5) * 1;
	    }
